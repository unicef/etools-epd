...
import {PdUnicefDetails} from './pdInterventionOverview.models';
import {selectPdUnicefDetails} from './pdUnicefDetails.selectors';
...
export class DetailsOverview extends connect(LitElement) {
  ...
  interventionOverview!: PdUnicefDetails;
  ...
  public stateChanged(state: any) {
    if (state.interventions.current) {
      this.interventionOverview = selectPdUnicefDetails(state);
      console.log('---------------------------------------------------------', this.interventionOverview);
    }
  }
