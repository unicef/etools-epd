...
// @lajos got it from PMP
import {pmpEndpoints} from '../../../utils/pmp-endpoints';
// @lajos bellowwill require PMP tokens
// @lajos bellow needs to be checked
import {tokenEndpointsHost, tokenStorageKeys, getTokenEndpoints} from '../../../../../../../config/config';
// import {ROOT_PATH} from '../../../config/config';
// @lajos bellow was added to common-methods
import {isJsonStrMatch} from '../../../common/types/types';
// @lajos bellow was added from PMP
import {Constructor, User, GenericObject} from '../../../common/models/globals.types';
